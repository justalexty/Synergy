import{M as x,a9 as te,R as c,C as ne,k as g,r as j,m,o as b,q as d,n as l,z as k,A as z,D as u,l as se,b as f,v as D,y as L,a4 as le,V,E as U,O as R,i as F,x as ce,S as A,K as T,a1 as q,T as de,U as ie,aa as ue,ab as he}from"./index-CTCKzTLC.js";import{P as _}from"./index-DvqJVokg.js";import{S as pe}from"./SwapController-C4Rq-p2o.js";const oe={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await te.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&ne.disconnect(),x.close()}},me=g`
  :host {
    display: block;
